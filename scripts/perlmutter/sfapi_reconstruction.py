...
if __name__ == '__main__':
    if len(sys.argv) < 3:
        print("Usage: python sfapi_reconstruction.py <file_name> <folder_path>")
        sys.exit(1)
    ...
    try:
        recon_dictionary, _  = recon_setup(filename = file_name, inputPath = f"raw/{folder_path}", outputPath = "scratch/"+folder_path)
        #, sinoused = (-1,1,1))
