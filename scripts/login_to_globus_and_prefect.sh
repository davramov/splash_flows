...
export TILED_URI="$TILED_URI"
export TILED_API_KEY="$TILED_API_KEY"
export NERSC_USERNAME="$NERSC_USERNAME"
export PATH_NERSC_CLIENT_ID="$PATH_NERSC_CLIENT_ID"
export PATH_NERSC_PRI_KEY="$PATH_NERSC_PRI_KEY"
