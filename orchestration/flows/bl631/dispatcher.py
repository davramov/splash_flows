...
from orchestration.flows.bl631.move import process_new_631_file
...
def dispatcher(
    ...
    """
    Dispatcher flow for BL631 beamline that launches the new_631_file_flow.

    :param file_path: Path to the file to be processed.
    :param is_export_control: Flag indicating if export control measures should be applied.
                              (Not used in the current BL631 processing)
    :param config: Configuration settings for processing.
                   Expected to be an instance of Config631 or a dict that can be converted.
    :raises ValueError: If no configuration is provided.
    :raises TypeError: If the provided configuration is not a dict or Config631.
    """

    logger.info("Starting dispatcher flow for BL 6.3.1")
