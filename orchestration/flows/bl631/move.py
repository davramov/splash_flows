...
from orchestration.flows.bl631.config import Config631
...
def process_new_631_file(
    ...
    prune(
        file_path=file_path,
        source_endpoint=config.data631_raw,
        check_endpoint=config.nersc631_alsdev_raw,
...
if __name__ == "__main__":
    ...
    process_new_631_file(file_path, config)
